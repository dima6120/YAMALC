...
fun ProfileScreen(
    ...
    ScreenWithComponent(
        ...
        when (state) {
            ...
            is ProfileState.Error -> ErrorScreen(state)
    ...
    Scaffold(
        ...
        Column(
            modifier = Modifier
                ...
                .padding(it)
                .padding(
                    horizontal = dimensionResource(id = com.dima6120.ui.R.dimen.padding_xl)
                )
                .padding(
                    top = dimensionResource(id = com.dima6120.ui.R.dimen.padding_xl)
                ),
            verticalArrangement = Arrangement.spacedBy(
                dimensionResource(id = com.dima6120.ui.R.dimen.space_s)
            )
        ) {
...
private fun UserInfoLine(
    ...
    Row(
        ...
        Spacer(
            modifier = Modifier.size(dimensionResource(id = com.dima6120.ui.R.dimen.space_xs))
        )
...
private fun AnimeValue(
    ...
    Column(
        modifier = modifier,
        verticalArrangement = Arrangement.spacedBy(
            dimensionResource(id = com.dima6120.ui.R.dimen.space_xs)
        )
    ) {
        Text(
            style = MaterialTheme.typography.subtitle1,
...
@Composable
private fun ErrorScreen(state: ProfileState.Error) {
    Box(modifier = Modifier.fillMaxSize()) {
        Text(
            modifier = Modifier.align(Alignment.Center),
